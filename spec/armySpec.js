describe("Army", function() {
  ...
  beforeEach(function() {
      // Creates an army before each test
      // Army needs units to be created
  });
  ...
  describe('takeDamage', function() {
    xit("Able to take damage from an attack", function() {
      unit.takeDamage(50);
  ...
  describe("getHealthNumber", function() {
    ...
    xit("Returns 6 when 54 is entered", function() {
      unit.takeDamage(46);
      expect(unit.getHealthNumber()).toEqual(6);
    });
    xit("Returns 10 when 98 is entered", function() {
      unit.takeDamage(2);
