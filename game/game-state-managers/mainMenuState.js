var mainMenuState = {
  ...
  create: function() {
    ...
    battleStateButton = new MenuButton(650, 310, "mainMenuButtons", "mapSelectState", "battleGround", "map", "army1", "army2", "battleButton", 0, 0, 1, 0);
    // battleStateButton.setButtonAnimation("");
    campaignStateButton = new MenuButton(650, 410, "mainMenuButtons", "mapSelectState", "campaign", "map", "army1", "army2", "battleButton", 2, 2, 3, 2);
    // campaignStateButton._setButtonAnimation("");
    instructionsStateButton = new MenuButton(650, 510, "mainMenuButtons", "instructionsState", "map", "army1", "army2", "battleButton", 4, 4, 5, 4);
